...
const sendVerificationEmail = async (to, otp) => {
    try {
        const mailOptions = {
            ...
            to: to,
            subject: 'Profile Verification Request - OTP Enclosed',
            html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 8px;">
                <h2 style="color: #333333; text-align: center;">Profile Verification OTP</h2>
                <p style="color: #555555; font-size: 16px;">Dear User,</p>
                <p style="color: #555555; font-size: 16px;">
                    We received a request to verify your account. Please use the OTP below to proceed with profile verification. 
                ...
                <p style="color: #555555; font-size: 16px;">
                    If you did not request this profile verification, please ignore this email. Your account will remain secure.
                </p>
