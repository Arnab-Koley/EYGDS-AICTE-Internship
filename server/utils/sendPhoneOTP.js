...
const sendPhoneOTP = async (to, otp) => {
    try {
        const mailOptions = {
            ...
            to: to,
            subject: 'Phone Verification Request - OTP Enclosed',
            html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #dddddd; border-radius: 8px;">
                <h2 style="color: #333333; text-align: center;">Phone Verification OTP</h2>
                <p style="color: #555555; font-size: 16px;">Dear User,</p>
                <p style="color: #555555; font-size: 16px;">
                    We received a request to verify your phone. Please use the OTP below to proceed with phone verification. 
