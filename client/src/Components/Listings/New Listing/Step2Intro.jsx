...
const Step2Intro = ({ handleNavigation }) => {
  ...
  return (
    <div>
      ...
      <div className="md:w-1/2 flex flex-col mx-32 max-md:mx-10 justify-center space-y-3   ">
        ...
        <h1 className='lg:text-5xl text-4xl max-md:text-2xl '>Make your place stand out</h1>
        <p className=' text-2xl md:text-xl max-md:text-base'>
        In this step, you'll create a title and description. Then add a attractive cover photo to make your listing stand out.
        </p>
      </div>
