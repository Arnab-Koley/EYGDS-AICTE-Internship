...
import step1video from '../../../assets/video/step1.mp4';
import { IoIosArrowRoundBack } from "react-icons/io";

const Step1Intro = ({ handleNavigation }) => {
  ...
  return (
    <div>
      ...
      <div className="md:w-1/2 flex flex-col mx-32 max-md:mx-10 justify-center space-y-3 max-md: mt-10 ">
        <h3 className='text-xl font-semibold'>Step 1</h3>
        <h1 className='lg:text-5xl text-4xl max-md:text-2xl '>Tell us about your place</h1>
        <p className=' text-2xl md:text-xl max-md:text-base'>
          In this step, we'll ask you which type of property you have and if guests
      ...
      <div className="md:w-1/2 flex justify-center items-center">
        <video
          ref={videoRef}
          src={step1video}
          className="h-80 max-md:h-60 border-none"
          controls={false}
          loop={false}
    ...
    <div className='flex justify-between px-32 max-md:px-10 py-20 max-md:py-10 items-center'>
